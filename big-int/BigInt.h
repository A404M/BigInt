...
private:
    [[nodiscard]] inline static UInt hHalf(UBInt);
    [[nodiscard]] inline static UInt lHalf(UBInt);
    ...
    inline void addToHolder(UBInt,decltype(holder)::size_type);
    inline void subToHolder(UInt,decltype(holder)::size_type);
public:
    ...
    [[maybe_unused]] BigInt &operator*=(BigInt);
    [[maybe_unused]] BigInt &operator*=(UInt);
    [[maybe_unused]] BigInt &operator/=(const BigInt&);
    [[maybe_unused]] BigInt &operator/=(UInt);
    [[maybe_unused]] BigInt &operator%=(const BigInt&);
